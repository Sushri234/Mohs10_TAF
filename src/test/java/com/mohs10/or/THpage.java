...
public class THpage {
	...
	//Author
	public static By author = By.xpath("//div[@class='elementor-element elementor-element-c1abcb2 elementor-button-info elementor-align-center elementor-widget elementor-widget-button animated pulse']//span[@class='elementor-button-text'][normalize-space()='Author an article']");
